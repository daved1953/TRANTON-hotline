...
Public Class myrepdata
    ...
    Public Class ReportDataDataTable
        ...
        Public Overloads Function AddReportDataRow( _
            ...
            rowReportDataRow.ItemArray = New Object() {AnonReq, Nothing, CallDate, CallStatus, CBtime, Comments, Confirmation, DOB, Fname, Lang, Lname, Phone, SID, Subscriber, verified, Verifiedby, VerifiedDate}
