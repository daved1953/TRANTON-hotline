...
Public Class CallUnverified
    ...
    Public Class ReportDataDataTable
        ...
        Public Overloads Function AddReportDataRow( _
            ...
            rowReportDataRow.ItemArray = New Object() {Expr1, Expr2, AnonReq, Nothing, CallDate, CallID, CallStatus, CBtime, Comments, Confirmation, DOB, Fname, Lang, Lname, Phone, SID, Subscriber, verified, Verifiedby, VerifiedDate}
        ...
        Private Sub InitClass()
            Me.columnExpr1 = New DataColumn("Expr1", GetType(System.Boolean), Nothing, System.Data.MappingType.Element)
    ...
    Public Class ReportDataRow
        ...
        Public Sub SetExpr2Null()
            Me(Me.tableReportData.Expr2Column) = System.Convert.DBNull
        End Sub
